...
<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import= "beans.NecesidadesDTO" %> 
...
<%
NecesidadesDTO obj=(NecesidadesDTO)request.getAttribute("Necesidad");
%>
<div class="content">
<main>
<div class="container">
