...
<div class="content">
	...
	<div class="header-btn">
        <a href="registrarActividad.jsp" class="btn btn-primary">Agregar</a>
</div>
                <br>
...
<td>${f.fechaFin}</td>
<td>${f.nomEquipo}</td>
<td align="center"><a href='ServletActividad?tipo=buscar&cod=${f.codigo}'>
<img src='img/editar.ico' title='Editar' style="width: 50px;height: 50px"></a></td>
<td align="center"><a href='ServletActividad?tipo=eliminar&cod=${f.codigo}'>
