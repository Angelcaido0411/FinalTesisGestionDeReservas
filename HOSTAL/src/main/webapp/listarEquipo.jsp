...
<div class="content">
	...
	<div class="header-btn">
        <a href="registrarEquipo.jsp" class="btn btn-primary">Agregar</a>
</div>
                <br>
...
<th scope="col" width=30%>ESPECIALIDAD</th>
<th scope="col" width=28%>ORGANIZACION</th>
...
<td align="center"><a href='ServletEquipo?tipo=buscar&cod=${f.codigo}'>
<img src='img/editar.ico' title='Editar' style="width: 50px;height: 50px"></a></td>
<td align="center"><a href='ServletEquipo?tipo=eliminar&cod=${f.codigo}'>
