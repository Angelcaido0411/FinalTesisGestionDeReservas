...
<div class="content">
	...
	<div class="header-btn">
        <a href="registrarMiembro.jsp" class="btn btn-primary">Agregar</a>
</div>
                <br>
...
<th scope="col" width=28%>ROL</th>
<th scope="col" width=35%>EQUIPO</th>
...
<td>${f.rol}</td>
<td>${f.nomEquipo}</td>
<td align="center"><a href='ServletMiembro?tipo=buscar&cod=${f.codigo}'>
<img src='img/editar.ico' title='Editar' style="width: 50px;height: 50px"></a></td>
<td align="center"><a href='ServletMiembro?tipo=eliminar&cod=${f.codigo}'>
