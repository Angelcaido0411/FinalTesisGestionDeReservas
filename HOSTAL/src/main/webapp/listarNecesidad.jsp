...
<div class="content">
	...
	<div class="header-btn">
        <a href="registrarNecesidad.jsp" class="btn btn-primary">Agregar</a>
</div>
                <br>
...
<th scope="col" width=33%>DESCRIPCION</th>
<th scope="col" width=10%>CANTIDAD REQUERIDA</th>
...
<td>${f.prioridad}</td>
<td>${f.estado}</td>
<td align="center"><a href='ServletNecesidad?tipo=buscar&cod=${f.codigo}'>
<img src='img/editar.ico' title='Editar' style="width: 50px;height: 50px"></a></td>
<td align="center"><a href='ServletNecesidad?tipo=eliminar&cod=${f.codigo}'>
