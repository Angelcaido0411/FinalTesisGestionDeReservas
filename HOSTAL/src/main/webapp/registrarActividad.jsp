...
<form action="ServletActividad?tipo=registrar" id="frmagregar" method="post">

<table align="center">


<div class="col-md-12">
<h1 align="center">Registrar Actividades</h1>
<br><br><br>
<label class="form-label">Descripcion</label>
<input type="text" class="form-control" name="txt_des" placeholder="Descripcion" class="required">
<br>
...
<div>
<ct:cboDinamico sql="SQL_EQUIPO" nombre="cbo_equipo"></ct:cboDinamico>
</div>
<br>
</div>
