...
<form action="ServletLogistica?tipo=registrar" id="frmagregar" method="post">
...
<div class="col-md-12">
<h1 align="center">Registrar Logistica</h1>
<br><br><br>


<label  for="cbo_suministro"class="form-label">Seleccione el suministro</label>
<div>
<ct:cboDinamico sql="SQL_SUMINISTRO" nombre="cbo_suministro"></ct:cboDinamico>
</div>
<br>
