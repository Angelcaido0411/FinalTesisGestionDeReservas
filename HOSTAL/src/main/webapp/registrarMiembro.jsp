...
<form action="ServletMiembro?tipo=registrar" id="frmagregar" method="post">

<table align="center">

<div class="col-md-12">
<h1 align="center">Registrar Miembros</h1>
<br><br><br>
...
<input type="text" class="form-control" name="txt_rol" placeholder="Rol">
